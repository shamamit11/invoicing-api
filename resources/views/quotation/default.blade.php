            ...
            <div class="content">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            ...
                            <div style="margin-bottom: 10px;"><strong>Quotation#:</strong> {{ $quote->quote_no }}
                            </div>
                            <div><strong>Invoice Date:</strong> {{ $quote->date }} </div>
                        </td>
                ...
                <table border="0" cellpadding="5" cellspacing="5" width="100%">
                    <tr style="vertical-align: top">
                        <td width="50%" style="line-height: 24px;">
                            <div style="margin-bottom: 12px; font-size: 20px; font-weight: 600;">Quote From</div>
                        ...
                        <td width="50%" style="line-height: 24px;">
                            <div style="margin-bottom: 12px; font-size: 20px; font-weight: 600;">Quote To</div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="items-row" style="text-align: right; padding-right: 8px"><strong>Tax
                                    ({{ $quote->tax_percent }}%)</strong></td>
                            <td class="items-row" style="text-align: right; padding-right: 8px"><small>{{ $organization->org_currency }}</small> {{ $quote->total_tax }}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="items-row" style="text-align: right; padding-right: 8px"><strong>Total
                                    Amount</strong></td>
                            <td class="items-row" style="text-align: right; padding-right: 8px"><small>{{ $organization->org_currency }}</small> {{ $subtotal + $quote->total_tax }}
                            </td>
                        </tr>
                ...
                @php 
                    if($organization->org_currency == 'AED') {
                        $amount_words = SpellNumber::value($subtotal + $quote->total_tax)->currency('dirhams')->fraction('fils')->toMoney();
                    }
                    else if($organization->org_currency == 'USD') {
                        $amount_words = SpellNumber::value($subtotal + $quote->total_tax)->currency('dollars')->fraction('cents')->toMoney();
                    }
                    else {
                        $amount_words = SpellNumber::value($subtotal + $quote->total_tax)->toLetters(); 
                    }
                @endphp
