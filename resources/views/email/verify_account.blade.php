...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" style="padding: 0;">
    <div id="wrapper" dir="ltr"
            ...
            <tr>
                <td align="center" valign="top">
                    <div id="template_header_image" style="margin-bottom:25px;">
                        <img src="https://portal.qalaqs.com/assets/admin/images/qalaqs-logo.png" alt="Qalaqs"
                            style="height: 55px;">
                    </div>
                        ...
                        <tr>
                            <td align="center" valign="top">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="600"
                                    id="template_header"
                                    style='background-color: #8c0000; color: #ffffff; border-bottom: 0; font-weight: bold; line-height: 100%; vertical-align: middle; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; border-radius: 3px 3px 0 0;'>
                                    <tr>
                                                ...
                                                <tr>
                                                    <td valign="top" style="padding: 25px 25px 0;">
                                                        <div id="body_content_inner"
                                                            ...
                                                            <p style="margin: 0 0 16px;">Thank you for registering with
                                                                EZ Invoicing. To proceed further, please verify your account
                                                                by clicking the link below:
                                                            </p>
                                                            <p style="font-size:16px; font-weight: bold">
                                                                <a href="{{ route('verify-user-email', [$token]) }}"
                                                                    style="color:blue; text-decoration:none"
                                                                    target="_blank">Click Here to Verify Your
                                                                    Account</a>
                                                            </p>
                                                            <p>&nbsp;</p>
                                                            <p>Thank You.</p>
                                                            <p style="font-weight: bold">EZ Invoicing Team
                                                                <br />
                                                            </p>
                                                            <p>&nbsp; <br />
                                                            </p>
        ...
        <div
            ...
            <a href="https://ezinvoicing.online" target="_blank"
                style="text-decoration:none; color:#8c0000;">www.ezinvoicing.online</a></div>
    </div>
</body>
